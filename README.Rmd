...
```{r, message = FALSE, warning = FALSE, fig5, fig.align = "center", fig.height = 3, fig.width = 5}
...
```{r, message = FALSE, warning = FALSE, fig6, fig.align = "center", fig.height = 3, fig.width = 5}

...
```{r, message = FALSE, warning = FALSE, fig1, fig.height = 3, fig.width = 5, fig.align = "center"}
...
```{r, message = FALSE, warning = FALSE, fig2, fig.height = 3, fig.width = 5, fig.align = "center"}

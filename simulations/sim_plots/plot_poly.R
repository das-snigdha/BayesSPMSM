...
load("simulations/sim_mcmc_output/out_poly_n50.Rdata")
load("simulations/sim_mcmc_output/out_poly_n100.Rdata")
load("simulations/sim_mcmc_output/out_poly_n300.Rdata")
load("simulations/sim_mcmc_output/out_poly_n500.Rdata")
...
g.all
ggsave("simulations/sim_plots/figures/simpoly.pdf", g.all, width = 7, height = 9)
